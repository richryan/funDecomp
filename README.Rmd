...
```{r fig-example, fig.alt = "Plot of adjusted and unadjusted rates of job finding.", message=FALSE, warning=FALSE}
...
ggplot(data = datfig) +
  ...
  theme_light()  
ggsave(here("out", "fig_README.png"))
```
...
Ryan, Rich. "Unemployment Volatility: When Workers Pay Costs upon Accepting Jobs." arXiv preprint [arXiv:2401.07423](https://doi.org/10.48550/arXiv.2401.07423) (2024).